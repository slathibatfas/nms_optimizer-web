      ...
      <div className="infodialog__item">
        ...
        <ol className="mb-4 infodialog__list">
          <li className="infodialog__list-item">
            <strong>Looks for a Known Solution:</strong> First, it checks if it already knows a good layout for the specific ship and technology you've chosen.
            These "known solutions" are like pre-made templates that are usually very effective. These are stored in the <code>solves</code> dictionary.
          </li>
          <li className="infodialog__list-item">
          ...
          <li className="infodialog__list-item">
            ...
            additional supercharged slots. It will try to move modules around to take advantage of these slots. It will focus on supercharged slots that are on
            the outer edge of the solve.
          </li>
          <li className="infodialog__list-item">
