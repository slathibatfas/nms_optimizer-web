 ...
 */
const GridTableInternal = React.forwardRef<HTMLDivElement, GridTableProps>(({ grid, activateRow, deActivateRow, solving, shared }, ref) => {
          ...
          <div role="row" key={rowIndex} aria-rowindex={rowIndex + 1}>
            ...
            <div role="gridcell" aria-colindex={totalAriaColumnCount}>
              <GridControlButtons
                ...
                isLastActiveRow={
                  row.some((cell) => cell.active) && rowIndex === lastActiveRowIndex && rowIndex >= grid.cells.length - 3 // Keep this specific condition if it's intended
                }
              />
            </div>
          </div>
