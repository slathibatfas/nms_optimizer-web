  ...
  return (
    <article className="appDialog__body">
      ...
      <ul className="appDialog__list">
        ...
        <li className="appDialog__listItem">Updated algorithm to prefer upper corners instead of lower left corner (it was annoying me). </li>
      ...
      <ul className="appDialog__list">
        <li className="appDialog__listItem">Implemented a larger, 8k sample model for Freighter Hyperdrive for higher accuracy.</li>
      ...
      <ul className="appDialog__list">
        <li className="appDialog__listItem">Increased "window" size to support better solves for Living Starships.</li>
      ...
      <ul className="appDialog__list">
        <li className="appDialog__listItem">Significant UI clean-up, optimization, and refactoring.</li>
      </ul>

      <h2 className="appDialog__subheading">Version 2.24 (2025-05-03)</h2>
      <ul className="appDialog__list">
        <li className="appDialog__listItem">Added solve quality visuals to notify user when a sub-optimal solve is generated.</li>
      </ul>
      ...
      <ul className="appDialog__list">
        ...
        <li className="appDialog__listItem">Fixed issue where "ghost" modules would sometimes persist after SA/Refine fallback solves were applied.</li>
      ...
      <ul className="appDialog__list">
        <li className="appDialog__listItem">Refactored opportunity (supercharger) windowing and scoring engine.</li>
      ...
      <ul className="appDialog__list">
        <li className="appDialog__listItem">Added correct Boltcaster / Forbidden Upgrade Module relationship.</li>
      ...
      <ul className="appDialog__list">
        <li className="appDialog__listItem">Renamed tool to Neural Technology Optimizer to reflect its new capabilities.</li>
        <li className="appDialog__listItem">Added support for TensorFlow (AI) based solves resulting in an ~5x performance boost.</li>
        ...
        <li className="appDialog__listItem">Various bug fixes, enhancements, and performance improvements.</li>
      </ul>

      <h2 className="appDialog__subheading">Version 1.1 (2025-04-07)</h2>
      <ul className="appDialog__list">
        <li className="appDialog__listItem">Improved scoring algorithms to provide more consistant solves.</li>
      ...
      <ul className="appDialog__list">
        ...
        <li className="appDialog__listItem">Calculations now take into account greater and lesser adjacency.</li>
        <li className="appDialog__listItem">Core Hyperdrive documented as lesser, but actually performs as greater.</li>
      ...
      <ul className="appDialog__list">
        <li className="appDialog__listItem">Enabled sharing and bookmarking of solves (grid serialization).</li>
      ...
      <ul className="appDialog__list">
        <li className="appDialog__listItem">Added support for optional modules received as Expedition rewards.</li>
        <li className="appDialog__listItem">Additional UI refinements.</li>
      ...
      <ul className="appDialog__list">
        ...
        <li className="appDialog__listItem">Updated the main font to match Hello Games branding.</li>
        <li className="appDialog__listItem">Additional UI refinements.</li>
        <li className="appDialog__listItem">Fixed incorrect image mapping for Photon Cannon upgrades.</li>
        <li className="appDialog__listItem">Reverted the default grid state to 3 rows.</li>
        <li className="appDialog__listItem">Added authorship footer and GitHub repository links.</li>
      </ul>
      ...
      <ul className="appDialog__list">
        ...
        <li className="appDialog__listItem">Fixed an issue where grid refinement failed to find the best solve; improved packing algorithms.</li>
      </ul>
