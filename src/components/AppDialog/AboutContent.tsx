  ...
  return (
    <article className="appDialog__body">
      ...
      <p className="appDialog__text">
        ...
        multi-tools, and freighters. The tool focuses on identifying the <strong>best tech layouts</strong> by maximizing adjacency bonuses and leveraging
        supercharged slots—core strategies for achieving the <strong>best starship layout</strong>, <strong>best multi-tool layout</strong>, or
      ...
      <ol className="appDialog__list">
        <li className="appDialog__listItem">
          <strong>Pattern-Based Pre-Solve:</strong> Begins with a curated library of hand-tested layout patterns, optimizing for maximum adjacency bonuses
          across different grid types.
        </li>
        <li className="appDialog__listItem">
          <strong>AI-Guided Placement (ML Inference):</strong> If a viable configuration includes supercharged slots, the tool invokes a TensorFlow model
          trained on 16,000+ grids to predict optimal placement.
        </li>
        <li className="appDialog__listItem">
          <strong>Simulated Annealing (Refinement):</strong> Refines the layout through stochastic search—swapping modules and shifting positions to boost
          adjacency scoring while avoiding local optima.
        </li>
        <li className="appDialog__listItem">
          <strong>Result Presentation:</strong> Outputs the highest-scoring configuration, including score breakdowns and visual layout recommendations for
          starships, multi-tools, and freighters.
        </li>
      </ol>
      ...
      <ul className="appDialog__list">
        <li className="appDialog__listItem">
          <strong>Grid-Aware Solving:</strong> Accounts for supercharged and inactive slots when determining the <strong>best layout configuration</strong>.
        </li>
        <li className="appDialog__listItem">
          <strong>TensorFlow ML Inference:</strong> Predicts optimal technology placement based on historical grid data.
        </li>
        <li className="appDialog__listItem">
          <strong>Simulated Annealing:</strong> Improves layout quality by exploring configuration shifts and adjacency-based swaps.
        </li>
      </ul>
      ...
      <p className="appDialog__text">
        Here's a look at an <strong>early version</strong> of the UI—functionally solid but visually minimal. The current version is a major upgrade in design,
        usability, and clarity, helping players quickly find the <strong>best layout</strong> for any ship or tool.
      </p>
      <img
