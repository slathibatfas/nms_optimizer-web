    ...
    <>
      <div className="flex flex-col items-center justify-center h-full p-8">
        ...
        <p className="pt-1 text-base text-center appContent__text">
          <strong>The server returned an error while attempting to optimize your layout.</strong> If the issue persists, please consider <a href="https://github.com/jbelew/nms_optimizer-web/issues" target="_blank" rel="noopener noreferrer" className="underline">filing a bug report</a>.
        </p>
      </div>
    </>
  );
